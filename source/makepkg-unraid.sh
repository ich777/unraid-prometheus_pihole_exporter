#!/bin/bash
PLUGIN_NAME="prometheus_pihole_exporter"
...
makepkg -l y -c y $TMP_DIR/gvt.g-$VERSION.txz
md5sum $TMP_DIR/gvt.g-$VERSION.txz | awk '{print $1}' > $TMP_DIR/gvt.g-$VERSION.txz.md5
